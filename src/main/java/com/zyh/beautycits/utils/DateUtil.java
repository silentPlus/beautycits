...
public class DateUtil {
	...
	// 日期格式，年月日时分，例如：16:40
	public static final String TIME_FORMAT_HHMI = "HH:mm";
	
	// 日期格式，年月日时分秒，例如：16:40:49
	public static final String TIME_FORMAT_HHMISS = "HH:mm:ss";
	...
	public final static java.sql.Date toSqlDateFromStrDate(String p_strDate,
		...
		java.text.DateFormat sdf = new java.text.SimpleDateFormat(p_format);
	 ...
	 * @Return: java.util.Date util.Date型日期
	 */
	public final static java.util.Date toUtilDateFromSqlDate(
	 ...
	 * @return int 年份
	 */
	public final static int getYearOfDate(java.util.Date p_date) {
	 ...
	 * @return int 月份
	 */
	public final static int getMonthOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		c.setTime(p_date);
	 ...
	 * @return int 日份
	 */
	public final static int getDayOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		c.setTime(p_date);
	 ...
	 * @return int 日份
	 */
	public final static int getHourOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		c.setTime(p_date);
	 ...
	 * @return int 分钟
	 */
	public final static int getMinuteOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		c.setTime(p_date);
	 ...
	 * @return int 秒钟
	 */
	public final static int getSecondOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		c.setTime(p_date);
	 ...
	 * @return long 毫秒
	 */
	public final static long getMillisOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		c.setTime(p_date);
	 ...
	 * @throws
	 */
	public final static String dateToStr(Long date, String format) {
		SimpleDateFormat dateFormat = new SimpleDateFormat(format);
	...
	public final static String getTheTime() throws Exception {
		...
		java.util.Date date1 = format.parse(getDateTime());
	...
	public final static String yearMonth() {
		return dateToStr(System.currentTimeMillis(), DateUtil.DATE_FORMAT_YYYY_MM);
	}
	...
	public final static String yearMonthDay() {
		return dateToStr(System.currentTimeMillis(), DateUtil.DATE_FORMAT_YYYY_MM_DD);
	}
	...
	public final static String getSysDate() {
		return dateToStr(System.currentTimeMillis(), DateUtil.DATE_FORMAT_YYYYMMDD);
	}
	...
	public final static String getDateTimeAll() {
		return dateToStr(System.currentTimeMillis(), DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
	}

	public final static String getDateTimeAll(Long date) {
		return dateToStr(date, DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
	}
	
	
	/**
	 * 取得当前时分秒的字符串 16:33:33
	 * 
	 * @return
	 */
	public final static String getTimeAll() {
		return dateToStr(System.currentTimeMillis(), DateUtil.TIME_FORMAT_HHMISS);
	}
	
	public final static String getTimeAll(Long time) {
		return dateToStr(time, DateUtil.TIME_FORMAT_HHMISS);
	}
	 ...
	 * @return
	 */
	public final static String getShortTimeAll() {
		return dateToStr(System.currentTimeMillis(), DateUtil.TIME_FORMAT_HHMI);
	}
	
	public final static String getShortTimeAll(Long time) {
		return dateToStr(time, DateUtil.TIME_FORMAT_HHMI);
	}

	
	public final static String getYearMonth() {
		return DateUtil.dateToStr(System.currentTimeMillis(), DateUtil.DATE_FORMAT_YYYYMM);
	}
	 ...
	 * @return int 季度
	 */
	public final static int getQuarterOfDate(java.util.Date p_date) {
		java.util.Calendar c = java.util.Calendar.getInstance();
		// c.setTime(p_date);
	...
	public static Date diffSeconds(Date date,int seconds){
        long diff = date.getTime() - 1000l*seconds;
